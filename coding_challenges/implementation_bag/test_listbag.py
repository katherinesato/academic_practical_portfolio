...
class CountTestCase(unittest.TestCase):
    ...
    def test_count2(self):
        ...
        bag = ListBag([2, 2, 2, 8, 9, 12, -15, -15, 27, 0, 0])
    ...
    def test_count3(self):
        ...
        bag = ListBag([5.2, 5.2, -4.0, 4.0, 5.78493])
    ...
    def test_count4(self):
        ...
        bag = ListBag(['a', 'a', "This", "A", "A", "Katherine", '3.2451'])
...
class RemoveTestCase(unittest.TestCase):
    ...
    def test_remove4(self):
        ...
        bag = ListBag([1.0, 3.7, 4.2, 4.2, 7.8, 2.79, 3.753])
    ...
    def test_remove7(self):
        ...
        bag = ListBag([[True, False], (1, 2), {33: "Name"}])
...
class GrabTestCase(unittest.TestCase):
    ...
    def test_grab5(self):
        ...
        bag1 = ListBag([[1, 2], [1, 2], [1, 2]])
        init_len = len(bag1)
        grabbed_item = bag1.grab()
        self.assertEqual(grabbed_item, [1, 2])
        self.assertEqual(len(bag1), init_len - 1)

        bag2 = ListBag([(1, 2), (1, 2), (1, 2)])
        init_len = len(bag2)
        grabbed_item = bag2.grab()
        self.assertEqual(grabbed_item, (1, 2))
        self.assertEqual(len(bag2), init_len - 1)

        bag3 = ListBag([{1: 2}, {1: 2}, {1: 2}])
        init_len = len(bag3)
...
class DunderAddTestCase(unittest.TestCase):
    ...
    def test_dunder_add1(self):
        """Test dunder add with elems that are not Listbags."""
        bag = ListBag([1, 5, 6, 8])
        not_bag = "Hi"
    ...
    def test_dunder_add2(self):
        """Test dunder add with empty ListBags."""
        bag1 = ListBag([1, 5, 6, 8])
        bag2 = ListBag()
        bag3 = bag1 + bag2
        bag1 = ListBag([1, 5, 6, 8])
        bag2 = ListBag()
        bag3 = bag1 + bag2
        self.assertEqual(bag3, ListBag([1, 5, 6, 8]))

        bag4 = ListBag()
        bag5 = ListBag()
        bag6 = bag4 + bag5
        self.assertEqual(bag6, ListBag([]))

    def test_dunder_add3(self):
        """Test dunder add with ListBags (int values)."""
        bag1 = ListBag([1, 5, 6, 8])
        bag2 = ListBag([40, 80, 90])
        bag3 = bag1 + bag2
        self.assertEqual(bag3, ListBag([1, 5, 6, 8, 40, 80, 90]))

    def test_dunder_add4(self):
        """Test dunder add with ListBags (float, 'double' values)."""
        bag1 = ListBag([1.0, 5.0, 6.0, 8.0])
        bag2 = ListBag([40.0])
        bag3 = bag1 + bag2
        self.assertEqual(bag3, ListBag([1.0, 5.0, 6.0, 8.0, 40.0]))

    def test_dunder_add5(self):
        """Test dunder add with ListBags (char, string values)."""
        bag1 = ListBag(['a', "Hi"])
        bag2 = ListBag(["Bee"])
        bag3 = bag1 + bag2
        self.assertEqual(bag3, ListBag(['a', "Hi", "Bee"]))

    def test_dunder_add6(self):
        """Test dunder add with ListBags (lists, tuples, dict values)."""
        bag1 = ListBag([[1, 2], (1, 2)])
        bag2 = ListBag([{1: 2}])
        bag3 = bag1 + bag2
        self.assertEqual(bag3, ListBag([[1, 2], (1, 2), {1: 2}]))


class EqTestCase(unittest.TestCase):

    def test_eq1(self):
        """Test __eq__ with objects that are not Listbags."""
        bag1 = ListBag([1, 5, 6, 8])
        not_bag1 = "Hi"
        self.assertFalse(bag1 == not_bag1)

        bag2 = ListBag([1, 5, 6, 8])
        not_bag2 = [1, 5, 6, 8]
        self.assertFalse(bag2 == not_bag2)

    def test_eq2(self):
        """Test __eq__ with objects that are Listbags."""
        bag1 = ListBag([1, 5, 6, 8])
        bag2 = ListBag([1, 5, 6, 8])
        bag3 = bag2
        bag4 = ListBag([40, 80, 90])
        bag5 = ListBag(['a', "Hello"])
        bag6 = bag5
    ...
    def test_eq3(self):
        """Test __eq__ with Listbags and order of elements."""
        bag1 = ListBag([1, 5, 6, 8])
        bag2 = ListBag([8, 5, 6, 1])
        bag3 = ListBag([1.1, 2.2, 3.3])
        bag4 = ListBag([1.1, 3.3, 2.2])
        bag5 = ListBag(['a', 'b'])
        bag6 = ListBag(['b', 'a'])
        bag7 = ListBag([[1, 2], (1, 2), {1: 2}])
        bag8 = ListBag([{1: 2}, [1, 2], (1, 2)])
        self.assertTrue(bag1 == bag2)
